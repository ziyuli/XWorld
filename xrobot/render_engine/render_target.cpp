...
void RenderTarget::append_rgba_float16_bilinear() {
	append(GL_LINEAR, GL_LINEAR, GL_RGBA16F, GL_RGBA, GL_FLOAT,
			GL_CLAMP_TO_EDGE);
}
...
void RenderTarget::append_rgb_float_bilinear() {
	append(GL_LINEAR, GL_LINEAR, GL_RGB32F, GL_RGB, GL_FLOAT,
			GL_CLAMP_TO_EDGE);
}
